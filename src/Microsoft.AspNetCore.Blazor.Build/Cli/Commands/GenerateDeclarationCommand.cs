...
{
    internal static class GenerateDeclarationCommand
    {
        public static void Command(CommandLineApplication command)
        {
            ...
            command.OnExecute(() =>
            {
                if (!VerifyOptions(sourceFilePaths.Values, outputFilePaths.Values, baseDirectory.Value(), baseNamespace.Value()))
                {
                    return 1;
                }
                ...
                var configuration = BlazorExtensionInitializer.DeclarationConfiguration;
        ...
        private static bool VerifyOptions(IList<string> sourceFilePaths, IList<string> outputFilePaths, string baseDirectory, string @namespace)
        {
            var hasErrors = false;
